    ...
    <div className="min-h-screen bg-gray-200 flex items-center justify-center relative overflow-hidden p-4">
      ...
      <div className="max-w-md w-full bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-10 border border-white/40 relative z-10">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to view your assigned tickets</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-12 py-3 rounded-xl border border-gray-200 bg-white/60 focus:bg-white focus:outline-none focus:ring-2 focus:ring-purple-400 transition-all"
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 text-lg font-semibold rounded-xl !text-white bg-gradient-to-r from-purple-500 to-indigo-600 shadow-lg shadow-purple-300/40 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-70"
          >
